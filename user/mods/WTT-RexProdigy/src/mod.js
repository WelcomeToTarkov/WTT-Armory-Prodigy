...
class WTTRexProdigy {
    ...
    displayCreditBanner() {
        ...
        this.Instance.logger.log(`[${this.modName}] Developers:           Rexana`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] Rexana is now a Prodigy`, LogTextColor_1.LogTextColor.GREEN);
        this.Instance.logger.log(`[${this.modName}] ------------------------------------------------------------------------`, LogTextColor_1.LogTextColor.GREEN);
    }
}
module.exports = { mod: new WTTRexProdigy() };
